...
return this.each( optall.complete );
  ...
  this.css({
    ...
    '-o-transition-duration': optall.duration + 'ms',
    '-o-transition-timing-function': optall.easing,
    'transition-property': 'all',
    'transition-duration': optall.duration + 'ms',
    'transition-timing-function': optall.easing
  });
